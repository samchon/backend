 ...
 * @module api.functional.bbs.managers.articles.reviews
 */
//================================================================
 ...
 * @controller BbsManagerArticleReviewsController.index()
 * @path PATCH /bbs/managers/articles/reviews/:code/
 */
    ...
    ): Promise<index.Output>
{
    ...
    (
        ...
        "PATCH",
        `/bbs/managers/articles/reviews/${code}/`,
        input
    );
}
...
/**
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 * @controller BbsManagerArticleReviewsController.at()
 * @path GET /bbs/managers/articles/reviews/:code/:id
 */
export function at
    (
        connection: IConnection,
    ...
    ): Promise<at.Output>
{
    ...
    (
        ...
        "GET",
        `/bbs/managers/articles/reviews/${code}/${id}`
    );
}
export namespace at
{
