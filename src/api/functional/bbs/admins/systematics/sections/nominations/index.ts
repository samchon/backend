 ...
 * @path GET /bbs/admins/systematics/sections/:code/nominations/:id
 */
export function store(connection: IConnection, code: string, id: string): Promise<store.Output>
{
    ...
    (
        ...
        "GET",
        `/bbs/admins/systematics/sections/${code}/nominations/${id}`
    );
}
 ...
 * @path DELETE /bbs/admins/systematics/sections/:code/nominations/:id
 */
