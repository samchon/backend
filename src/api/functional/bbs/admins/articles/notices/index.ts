 ...
 * @module api.functional.bbs.admins.articles.notices
 */
//================================================================
 ...
 * @controller BbsAdminArticleNoticesController.index()
 * @path PATCH /bbs/admins/articles/notices/:code/
 */
export function index(connection: IConnection, code: string, input: Primitive<index.Input>): Promise<index.Output>
{
    ...
    (
        ...
        "PATCH",
        `/bbs/admins/articles/notices/${code}/`,
        input
    );
}
...
/**
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 * @controller BbsAdminArticleNoticesController.at()
 * @path GET /bbs/admins/articles/notices/:code/:id
 */
export function at(connection: IConnection, code: string, id: string): Promise<at.Output>
{
    ...
    (
        ...
        "GET",
        `/bbs/admins/articles/notices/${code}/${id}`
    );
}
export namespace at
{
